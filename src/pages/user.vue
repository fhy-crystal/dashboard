...
<script>
	import activeLine from '@/components/user_activeLine'; // 实时活跃数量组件
	import activeMap from '@/components/user_activeMap'; // 活跃区域组件
	import top10 from '@/components/user_top10'; // top10组件
	import activeNum from '@/components/user_activeNum'; // 活跃数量组件 
